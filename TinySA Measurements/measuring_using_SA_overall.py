...
total_power_path = fr'C:\Users\wonde\Documents\Extra_School_files\NSERC Research\TinySA_measurement_stuff\recording_campus\total_power.csv'
...
def get_value():
    ...
    individual_measurement_path = fr'C:\Users\wonde\Documents\Extra_School_files\NSERC Research\TinySA_measurement_stuff\recording_campus\recorded_values_{file_increment}.csv'
...
while True:
    value = get_value()
    print(f"value = {value} for file = {file_increment}")
    time.sleep(0.7)
